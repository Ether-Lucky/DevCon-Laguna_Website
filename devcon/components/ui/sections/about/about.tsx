import AboutDevconSlideshow from '@/components/ui/sections/about/about-devcon-slideshow';

export default function About() {
  return (
    <section id="about" className="max-w-7xl mx-auto">
      <div className="w-full bg-background px-8 lg:px-16 lg:px-4 py-12 mx-auto gap-16 flex flex-row items-center">
        <div className="lg:max-w-xl">
          <span className="text-base sm:text-xl uppercase tracking-wide text-devcon-lime-500">
            {'// About DevCon Laguna'}
          </span>
          <h2 className="mt-4 text-4xl lg:text-6xl font-bold tracking-tight text-foreground">
            Who <span className="text-devcon-purple-700">We Are</span>
          </h2>
          <p className="mt-6 font-normal leading-relaxed text-foreground">
