    ...
    >
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
        <div className="max-w-xl">
          <span className="text-xl font-medium uppercase tracking-wide text-muted sm:text-2xl">
            About DevCon Laguna
          </span>
          ...
          <p className="mt-6 text-body-md font-normal leading-relaxed text-foreground">
